...
if (missionNamespace setVariable LICENSE_VARNAME("hero","civ")) then { license_civ_rebel = false;};
if (missionNamespace setVariable LICENSE_VARNAME("rebel","civ")) then { license_civ_hero = false;};