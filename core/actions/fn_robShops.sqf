...
_shop = [_this,0,ObjNull,[ObjNull]];
_robber = [_this,1,ObjNull,[ObjNull]];
_action = [_this,2];
...
if (currentWeapon _robber == "") exitWith { hint "HaHa, du machst mir keine Angst ,  raus hier du Lappen !!" };//is he trying to rob without a weapon? Lets taunt him a bit!
