...
//abetterworld.de//
//////////////////
[0,format["%1 der Feigling wird nun elendlich an Zyankali verenden!",player getVariable["realname",name player]]] remoteExec ["life_fnc_broadcast",0];// globale nachricht an alle spieler
