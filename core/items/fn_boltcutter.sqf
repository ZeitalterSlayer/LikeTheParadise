...
if (("Bankgebaeude") == _building) && (west countSide playableUnits < (LIFE_SETTINGS(getNumber,"minimum_cops")))) exitWith {
    hint format [localize "STR_Civ_NotEnoughCops",(LIFE_SETTINGS(getNumber,"minimum_cops"))]
};
if ((typeOf _building) == "Land_Research_house_V1_F" && (nearestObject "Bankgebaeude") getVariable ["locked",true]) exitWith {hint localize "STR_ISTR_Bolt_Exploit"};
...
if ((nearestObject ("Bankgebaeude") == _building) then {
